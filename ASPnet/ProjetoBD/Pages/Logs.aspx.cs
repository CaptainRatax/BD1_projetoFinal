...
namespace ProjetoBD.Pages
{
	public partial class Logs : Page
	{
		...
		{
			SqlData_Logs.SelectCommand = "SELECT Logs.LogDescription, Logs.LogDate, LogTypes.Name AS 'Action' FROM Logs INNER JOIN LogTypes ON Logs.LogType = LogTypes.ID WHERE 1 = 1";
			SqlData_Logs.DataBind();
		}
	}
}